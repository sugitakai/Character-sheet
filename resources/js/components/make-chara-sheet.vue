<template>
  <div class="chara-sheet">
    ...
    <!-- ==================================================
         ◆ 冒険の軌跡
    ================================================== -->
    <section class="sheet-section adventure-history">
    ...
    <!-- ==================================================
         ■ 戦闘判定
    ================================================== -->
    <section class="sheet-section check-section">
    ...
    <section class="sheet-section check-section">
      ...
      <p class="not-acquired">未取得</p>

      <div class="work-effect-list">
